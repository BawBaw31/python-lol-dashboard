...
# My team stats
team_stats = knockout_stage_dataset[(
    knockout_stage_dataset["Team"] == "G2")].reset_index().sort_values(by=['Position'])
...
aggregation = {"KDA Ratio": "mean",
               ...
               "Minutes Played": "sum",
               "Games Played": "sum"}
mean_stats_by_team_by_position = knockout_stage_dataset.groupby(
    ["Team", "Position"]).agg(aggregation).reset_index()
